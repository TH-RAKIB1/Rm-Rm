...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO RAKIB TOOLS     \033[1;92m      │")
...
class __crack__:
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36mRAKIB PROCESS HAS BEEN STARTED')
...
class __filecrack3__:
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36m RAKIB PROCESS HAS BEEN STARTED')
